		...
		<div>
			...
			<div className="flex py-14">
				<div className="w-1/2 flex flex-col justify-center space-y-4 px-16">
					...
					<div>
						<p>
							Whether you’re looking for personal development or interest.
							EduHub has you covered. Start TODAY
						</p>
					</div>

					<div>
						<Button>Get 10% Discount</Button>
					</div>

					<div>
						<p className="text-sm text-gray-400">*Terms & Conditions applied</p>
					</div>
				</div>
			...
			<div className="bg-color7 pb-8">
				...
				<div className="py-3 flex justify-center">
					<Link href="/category-list">
						<Button className="px-8">Explore More</Button>
					</Link>
				</div>
			</div>
			...
			<div className="flex flex-col">
				<div className="flex justify-center py-10">
					<h1 className="font-bold text-2xl">Why EduHub?</h1>
				</div>
				...
				<div className="flex space-x-4 justify-center px-24 pb-10">
					<div className="flex flex-col w-1/4 p-6">
						...
						<div className="flex flex-col items-center justify-center h-1/2 space-y-4 py-2">
							<div className="font-bold text-lg">Certificate of Completion</div>

							<div className="text-center">
								Boost your resume with certificates showcasing your newly
								acquired skills.
							</div>
						</div>
					</div>
					...
					<div className="flex flex-col w-1/4 p-6">
						...
						<div className="flex flex-col items-center justify-center h-1/2 space-y-4 py-2">
							<div className="font-bold text-lg">In-Demand Course</div>

							<div className="text-center">
								Our courses cover the latest and most relevant topics in techn,
								business, and more.
							</div>
						</div>
					</div>
					...
					<div className="flex flex-col w-1/4 p-6">
						...
						<div className="flex flex-col items-center justify-center h-1/2 space-y-4 py-2">
							...
							<div className="text-center">
								Once enrolled, you would have a lifetime access to the course
								material provided.
							</div>
						</div>
					</div>
					...
					<div className="flex flex-col w-1/4 p-6">
						...
						<div className="flex flex-col items-center justify-center h-1/2 space-y-4 py-2">
							<div className="font-bold text-lg">Value for Money</div>

							<div className="text-center">
								Enjoy top-tier courses at competitive prices to make learning
								more accessible.
							</div>
						</div>
					</div>
				...
				<div className="flex bg-color8 rounded-t-2xl">
					...
					<div className="pr-20  w-1/2 flex justify-center items-center flex-col space-y-6">
						...
						<p className="text-white text-xl text-justify">
							EduHub provide a platform for educators around the world to teach
							what you interested in and start making a difference today. Your
							knowledge might inspire and transform others live. Sign up now and
							embark on a rewarding journey with us.
						</p>

						<Link href="/trainer-dashboard">
							<Button className="bg-white text-color8">Start Teaching</Button>
						</Link>
					</div>
				</div>
			</div>
