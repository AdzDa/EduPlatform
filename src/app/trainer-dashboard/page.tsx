	...
	return (
		<div className="flex">
			<div className="h-screen flex flex-col w-1/5 p-4 border-r">
				...
				<div className="pt-8">
					<Button className="w-full">Homepage</Button>
				</div>
			</div>
			...
			<div className="flex flex-col w-4/5">
				...
				<div className="mx-5 text-xl font-semibold my-5">Hi {userName}!</div>
				...
				<div className="p-4 flex space-x-4">
					...
					<div className="flex space-x-4 w-1/2 border p-2 rounded-lg">
						<div className="w-4/5 flex flex-col space-y-2 p-2">
							<h3 className="font-bold">Number of Students</h3>
						...
						<TabsContent value="published">
							<ul className="grid grid-cols-3 gap-4 flex flex-col">
								{courseList.map((detail, index) => (
									<li
										key={index}
										className="hover:border-gray-400, hover:border-2">
